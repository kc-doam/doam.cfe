...
Адаптивное расширение ДОАМ включает поля множественного выбора и панель отбора записей 
по всем полям контрагента (включая дополнительные реквизиты).
...
6. [Калькулятор обновлений типовых конфигураций 1С](https://www.f1pro.ru/1c-updates-calc/)
