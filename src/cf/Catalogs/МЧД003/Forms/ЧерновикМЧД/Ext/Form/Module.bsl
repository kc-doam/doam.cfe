...
Процедура НачатьРедактированиеТелефона(СтандартнаяОбработка, ИмяЭлемента)
	...
	ТелефонЗначениеПолей = ЗначениеПолейКонтактнойИнформации(Телефон, ТипТелефон);
	
	ДанныеКонтактнойИнформации =
		ИнтеграцияБСПБЭДСлужебныйВызовСервера.ДанныеКонтактнойИнформацииПоПредставлению(Телефон, ТипТелефон);
	...
	ПараметрыФормы = УправлениеКонтактнойИнформациейКлиент.ПараметрыФормыКонтактнойИнформации(
		ПараметрыВида, ТелефонЗначениеПолей, Телефон, , ТипТелефон);
