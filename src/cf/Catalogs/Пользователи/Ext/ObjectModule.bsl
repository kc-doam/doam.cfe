...
Процедура ПриЗаписи(Отказ)
	...
	// Важно для распределенной ИБ, в периферийном узле, в остальных случаях - как перестраховка, могут не обновиться
	// роли:
	УправлениеДоступом.ОбновитьРолиПользователей(Ссылка);
