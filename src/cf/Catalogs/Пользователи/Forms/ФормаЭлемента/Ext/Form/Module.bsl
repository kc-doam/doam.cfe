...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПереопределитьОтображениеКонтактнойИнформации();
...
&НаСервере
Процедура ПереопределитьОтображениеКонтактнойИнформации()

	ИмяРеквизита = УправлениеКонтактнойИнформацией.ОпределитьЭлементСПочтойДляВосстановленияПароля(
		ЭтотОбъект,
		ПользовательИБАдресЭлектроннойПочты,
		ПользователиСлужебный.ДоступноРедактированиеПочтыДляВосстановленияПароля(УровеньДоступа, Объект));
		
	Элементы[ИмяРеквизита].Родитель.ОтображениеПодсказки = ОтображениеПодсказки.ОтображатьСнизу;
