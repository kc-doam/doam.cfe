...
Процедура МК_НастроитьЭлементыФормы()
	...
	// Реквизиты.
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Наименование);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.КодСДР);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Владелец);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Родитель);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ТипПредмета);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Предмет);

	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ТекущийПланЕдиницаДлительности);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ЕдиницаДлительностиФакт);
	...
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ТекущийПланТрудозатраты);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ТекущийПланЕдиницаТрудозатрат);
	
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ТрудозатратыФакт);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ЕдиницаТрудозатратФакт);
	...
	// Настройки.
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Важность);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ГрафикРаботы);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ТипОграничения);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ДатаОграничения);
