...
Процедура ОбработкаОжидания()
	...
	Если ЗначениеЗаполнено(ТекущаяПапка) Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(СписокВнутренние, "Папка", ТекущаяПапка);
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(СписокВнутренние, "Папка", ТекущаяПапка, Ложь);
	КонецЕсли;
