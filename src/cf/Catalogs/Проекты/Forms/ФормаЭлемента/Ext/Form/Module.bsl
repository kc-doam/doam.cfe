...
Процедура МК_НастроитьЭлементыФормы()
	...
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ЗаказчикТекст);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ГрифДоступа);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Состояние);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ВидПроекта);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Организация);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Подразделение);
	...
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.СпособПланирования);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.Родитель);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ЕдиницаТрудозатратЗадач);
	МобильныйКлиентАдаптацияИнтерфейсаСервер.ВыровнятьЭлементФормы(Элементы.ЕдиницаДлительностиЗадач);
	
	// Доступ.
	Элементы.РабочаяГруппаТаблица.Шапка = Ложь;
	Элементы.РабочаяГруппаТаблицаДобавить.Отображение = ОтображениеКнопки.Текст;
	
	Элементы.ФормаОбновитьИзMSProject.Видимость = Ложь;
