...
Процедура УстановитьДоступностьЭлементовФормы()
	...
	Элементы.ФормаПросмотретьТекстовыйОбраз.Доступность
		= (ДоступныДействияСФайлом И ДанныеФайла.СтатусРаспознаванияТекста = "Распознано");
...
Процедура ПродлитьДействиеПодписей(Команда)
	...
	РаботаСЭПКлиент.ПродлитьДействиеПодписей(ЭтотОбъект, УИДПодписи, ОбработчикПродолжения);
...
Процедура ОткрытьТекстовыйОбраз(Команда)
	...
	ОткрытьТекстовыйОбразВыполнить();
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьТекстовыйОбразВыполнить()
...
Процедура КомандаЕще(Команда)
	...
	Если Элементы.ФормаПросмотретьТекстовыйОбраз.Доступность = Истина Тогда
		СписокЗначений.Добавить("ОткрытьТекстовыйОбраз",
			НСтр("ru = 'Открыть распознанный текст'"));
	КонецЕсли;
...
Процедура КомандаЕщеВыбораЗначенияПродолжение(Результат, Параметры) Экспорт
	...
	ИначеЕсли Результат.Значение = "Распознать" Тогда
		РаспознатьВыполнить();
	ИначеЕсли Результат.Значение = "ОткрытьТекстовыйОбраз" Тогда
		ОткрытьТекстовыйОбразВыполнить();
	КонецЕсли;
