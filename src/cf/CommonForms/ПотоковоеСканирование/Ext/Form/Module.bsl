...
Процедура ОткрытьСписокНераспознанныхИзображений(Команда)
	...
	ПараметрыФормы = Новый Структура("МассивПутейНераспознанныхФайлов, ТекстНастроек, ТипЗагрузки, ПутьКПрограммеКонвертации, ФорматХраненияОдностраничный, ФорматХраненияМногостраничный, УдалятьФайлыПослеЗагрузки, ФайлыДляУдаления, СпособПреобразованияВPDF", 
