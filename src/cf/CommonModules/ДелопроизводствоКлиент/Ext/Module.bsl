...
//
// Параметры:
//  Объект - ДанныеФормыСтруктура - данные документа на форме.
//  Текст - Строка - введенная с клавиатуры поисковая строка.
//
// Возвращаемое значение:
//  СписокЗначений из ПеречислениеСсылка.СтавкиНДС
//
Функция ДанныеВыбораСтавкиНДС(Объект, Текст = "") Экспорт
	...
	Если ЗначениеЗаполнено(Объект.ДатаРегистрации) Тогда
		ДанныеВыбора = ДелопроизводствоВызовСервера.ДанныеВыбораСтавкиНДС(Текст, Объект.ДатаРегистрации);
	ИначеЕсли Не ЗначениеЗаполнено(Объект.ДатаРегистрации) И Объект.ДатаНачалаДействия > ТекущаяДатаСеанса Тогда
		ДанныеВыбора = ДелопроизводствоВызовСервера.ДанныеВыбораСтавкиНДС(Текст, Объект.ДатаНачалаДействия);
	ИначеЕсли ЗначениеЗаполнено(Текст) Тогда
		ДанныеВыбора = ДелопроизводствоВызовСервера.ДанныеВыбораСтавкиНДС(Текст);
	ИначеЕсли Не ЗначениеЗаполнено(Текст) Тогда
		ДанныеВыбора = ДелопроизводствоВызовСервера.ДанныеВыбораСтавкиНДС(, Объект.ДатаСоздания);
	КонецЕсли;
