...
//
Функция АвтоЗаголовокДела(ЗаголовокНоменклатурыДел, НомерТома, НомерЧасти) Экспорт
	
	АвтоЗаголовокДела = ""; 
	
	Если Не ЗначениеЗаполнено(ЗаголовокНоменклатурыДел) Тогда
		Возврат АвтоЗаголовокДела;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(НомерТома) Тогда
		Если ЗначениеЗаполнено(НомерЧасти) Тогда
			АвтоЗаголовокДела = СтрШаблон(НСтр("ru = '%1 (том №%2, ч. %3)'"),
				СокрЛП(ЗаголовокНоменклатурыДел), НомерТомаСтрокой, НомерЧастиСтрокой);
		Иначе
			АвтоЗаголовокДела = СтрШаблон(НСтр("ru = '%1 (том №%2)'"),
				СокрЛП(ЗаголовокНоменклатурыДел), НомерТомаСтрокой);
		КонецЕсли;
	Иначе
		Если ЗначениеЗаполнено(НомерЧасти) Тогда
			АвтоЗаголовокДела = СтрШаблон(НСтр("ru = '%1 (ч. %2)'"),
				СокрЛП(ЗаголовокНоменклатурыДел), НомерЧастиСтрокой);
		Иначе
			АвтоЗаголовокДела = СокрЛП(ЗаголовокНоменклатурыДел);
		КонецЕсли;
	КонецЕсли;
...
// Возвращает дату начала действия ставок НДС 5% и 7%.
//
// Возвращаемое значение:
//  Дата
//
Функция ДатаНачалаДействияСтавокНДС5и7() Экспорт
	
	Возврат Дата(2025, 1, 1);
	
КонецФункции

// Возвращает дату начала действия ставки НДС 18%.
//
// Возвращаемое значение:
//  Дата
//
Функция ДатаНачалаДействияСтавкиНДС18() Экспорт
	
	Возврат Дата(2004, 1, 1);
	
КонецФункции

// Возвращает дату прекращения действия ставки НДС 18%.
//
// Возвращаемое значение:
//  Дата
//
Функция ДатаПрекращенияДействияСтавкиНДС18() Экспорт
	
	Возврат Дата(2018, 12, 31, 23, 59, 59);
	
КонецФункции

// Возвращает дату начала действия ставки НДС 20%.
//
// Возвращаемое значение:
//  Дата
//
Функция ДатаНачалаДействияСтавкиНДС20() Экспорт
	
	Возврат Дата(2019, 1, 1);
	
КонецФункции

// Возвращает дату прекращения действия ставки НДС 20%.
//
// Возвращаемое значение:
//  Дата
//
Функция ДатаПрекращенияДействияСтавкиНДС20() Экспорт
	
	Возврат Дата(2025, 12, 31, 23, 59, 59);
	
КонецФункции

// Возвращает дату начала действия ставки НДС 22%.
//
// Возвращаемое значение:
//  Дата
//
Функция ДатаНачалаДействияСтавкиНДС22() Экспорт
