...
Функция ПороговыйКоэффициентДляЗаписиПравПоштучно() Экспорт
	...
	ЗначениеИзНастроек = Константы.ПороговыйКоэффициентДляЗаписиПравПоштучно.Получить();
	Коэффициент = ?(ЗначениеИзНастроек = 0, ЗначениеПоУмолчанию, ЗначениеИзНастроек);
