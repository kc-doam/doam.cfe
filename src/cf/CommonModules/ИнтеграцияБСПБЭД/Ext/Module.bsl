...
Функция УстановленныеПодписиОбъектов(ПодписанныеОбъекты) Экспорт
	...
	РаботаСЭП.ПередЧтениемЭПОбъектов(ПодписанныеОбъекты);
	...
	Пока Выборка.Следующий() Цикл
		...
		СвойстваПодписи.Сертификат = ЭлектроннаяПодписьДокументооборот.СертификатИзДвоичныхДанныхПодписи(СвойстваПодписи.Подпись);
