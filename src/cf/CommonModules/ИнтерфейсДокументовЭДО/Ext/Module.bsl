...
Функция СформироватьФайлыВыгрузкиЭДДокументооборотЦеликом(Знач ЭлектронныеДокументы, Знач ИдентификаторФормы) Экспорт
	...
	ПрисоединенныеФайлыЭД = ЭлектронныеДокументыЭДО.ПрисоединенныеФайлыЭлектронныхДокументов(ЭлектронныеДокументы);
	ПрисоединенныеФайлыЭД.Индексы.Добавить("ЭлектронныйДокумент");
	
	Если ПрисоединенныеФайлыЭД.Количество() = 0 Тогда
		Возврат СоответствиеДанныеФайлаАдресВХранилище;
	КонецЕсли;
	
	СообщенияЭДО = ПрисоединенныеФайлыЭД.ВыгрузитьКолонку("СообщениеЭДО");
	...
	Для каждого ЭлектронныйДокумент Из ЭлектронныеДокументы Цикл
		...
		ФайлыДокумента = ПрисоединенныеФайлыЭД.НайтиСтроки(Новый Структура("ЭлектронныйДокумент", ЭлектронныйДокумент));
