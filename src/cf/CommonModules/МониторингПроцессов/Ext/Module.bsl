...
Функция АгрегатнаяФункция(ВариантРасчета)
	...
	Если ВариантРасчета.СпособРасчета = Перечисления.СпособыРасчетаПоказателейПроцессов.Количество Тогда
		АгрегатнаяФункция = "СУММА";
	ИначеЕсли ВариантРасчета.СпособРасчета = Перечисления.СпособыРасчетаПоказателейПроцессов.Максимум Тогда
		АгрегатнаяФункция = "МАКСИМУМ";
	ИначеЕсли ВариантРасчета.СпособРасчета = Перечисления.СпособыРасчетаПоказателейПроцессов.Минимум Тогда
		АгрегатнаяФункция = "МИНИМУМ";
	ИначеЕсли ВариантРасчета.СпособРасчета = Перечисления.СпособыРасчетаПоказателейПроцессов.Среднее Тогда
		АгрегатнаяФункция = "СРЕДНЕЕ";
	ИначеЕсли ВариантРасчета.СпособРасчета = Перечисления.СпособыРасчетаПоказателейПроцессов.Сумма Тогда
		АгрегатнаяФункция = "СУММА";
	Иначе
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Неизвестный способ расчета %1.'"),
