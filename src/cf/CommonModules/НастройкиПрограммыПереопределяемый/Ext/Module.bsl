...
Процедура ПечатныеФормыОтчетыИОбработкиПриСозданииНаСервере(Форма) Экспорт
	...
	Элементы = Форма.Элементы;
	Элементы.ГруппаЗаголовок.Видимость = Ложь;
	Элементы.ГруппаОтчетыУниверсальныйОтчет.Видимость = Ложь;
	Элементы.ГруппаНастройкиИсторииРассылкиОтчетов.Видимость = Ложь;
	Элементы.ГруппаДополнительныеОтчетыИОбработкиИспользование.Видимость = Ложь;
	
	Элементы.Переместить(Элементы.ОткрытьРассылкиОтчетов, Элементы.ГруппаКолонки);
