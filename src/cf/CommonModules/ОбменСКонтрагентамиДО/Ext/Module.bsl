...
Функция ДанныеДокументаЭДОПоВерсииФайла(ОбъектУчета, Параметры) Экспорт
	...
	Если Параметры.ТипДокумента = Перечисления.ТипыДокументовЭДО.АктСверкиВзаиморасчетов
		И ТипЗнч(Параметры.Отправитель) = Тип("СправочникСсылка.Организации")
		И ТипЗнч(ДеревоЭД) = Тип("ДеревоЗначений") Тогда
		
		Для Каждого Строка Из ДанныеЭДФайла.НовыйЭД.ЗначениеРеквизита.Строки Цикл
			
			Если Строка.ПолныйПуть = "СведенияПодписанта" Тогда
	...
	ИначеЕсли Параметры.Формат = ПоддерживаемыеФорматы.ФНС.УПД_5_02.ИнформацияПродавца Тогда
		
		НеобязательныеРеквизиты = Новый Массив;
		
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.Исправление");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПродавцах.НомерСтроки.Продавец.Адрес.ТипАдреса.АдресГАР.ГородСелоПоселение");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПродавцах.НомерСтроки.Продавец.Адрес.ТипАдреса.АдресГАР.НаселенныйПункт");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПродавцах.НомерСтроки.Продавец.Адрес.ТипАдреса.АдресГАР.ЭлементПланировочнойСтруктуры");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПродавцах.НомерСтроки.Продавец.Адрес.ТипАдреса.АдресГАР.ПомещениеЗдания");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПродавцах.НомерСтроки.Продавец.Адрес.ТипАдреса.АдресГАР.ПомещениеКвартиры");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПокупателях.НомерСтроки.Покупатель.Адрес.ТипАдреса.АдресГАР.ГородСелоПоселение");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПокупателях.НомерСтроки.Покупатель.Адрес.ТипАдреса.АдресГАР.НаселенныйПункт");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПокупателях.НомерСтроки.Покупатель.Адрес.ТипАдреса.АдресГАР.ЭлементПланировочнойСтруктуры");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПокупателях.НомерСтроки.Покупатель.Адрес.ТипАдреса.АдресГАР.ПомещениеЗдания");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОПокупателях.НомерСтроки.Покупатель.Адрес.ТипАдреса.АдресГАР.ПомещениеКвартиры");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОГрузополучателях.НомерСтроки.Грузополучатель.Адрес.ТипАдреса.АдресГАР.ГородСелоПоселение");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОГрузополучателях.НомерСтроки.Грузополучатель.Адрес.ТипАдреса.АдресГАР.НаселенныйПункт");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОГрузополучателях.НомерСтроки.Грузополучатель.Адрес.ТипАдреса.АдресГАР.ЭлементПланировочнойСтруктуры");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОГрузополучателях.НомерСтроки.Грузополучатель.Адрес.ТипАдреса.АдресГАР.ПомещениеЗдания");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.СведенияОГрузополучателях.НомерСтроки.Грузополучатель.Адрес.ТипАдреса.АдресГАР.ПомещениеКвартиры");
		НеобязательныеРеквизиты.Добавить("СведенияОСчетеФактуре.ДополнительныеСведенияОбУчастниках.СведенияОГосКонтракте");
		
		Для Каждого Реквизит Из НеобязательныеРеквизиты Цикл
			
			Значение = ЭлектронноеВзаимодействие.ЗначениеРеквизитаВДереве(ДеревоЭД, Реквизит);
			Если Значение = Истина Тогда
				
				ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(ДеревоЭД, Реквизит, Неопределено);
				
			КонецЕсли;
			
		КонецЦикла;
		
		Строка = ЭлектронноеВзаимодействие.СтрокаДерева(ДеревоЭД, "СведенияОСчетеФактуре.ДополнительныеСведенияОбУчастниках.СведенияОГосКонтракте.ДатаКонтракта",  Истина);
		Строка.Обязательное = Ложь;
		
		Строка = ЭлектронноеВзаимодействие.СтрокаДерева(ДеревоЭД, "СведенияОСчетеФактуре.ДополнительныеСведенияОбУчастниках.СведенияОГосКонтракте.НомерКонтракта",  Истина);
		Строка.Обязательное = Ложь;
