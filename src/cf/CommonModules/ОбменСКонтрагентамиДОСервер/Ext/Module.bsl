...
Функция СформироватьЭДПоДокументуДО(КонтекстФормирования)
	...
	Исключение
		...
		ОписаниеПроблемы =
			НСтр("ru = 'При создании документа ДО по внутреннему документу возникли ошибки:'")
			+ Символы.ПС
...
Функция ВозможностьСозданияЭД(КонтекстФормирования)
	...
	ТаблицыПроверки = ТаблицыДляПроверкиВозможностиФормирования(КонтекстФормирования.Документ);
...
Функция СформироватьФормализованныйЭД(КонтекстФормирования)
	...
	ЭлектронныйДокумент = ИнтеграцияЭДО.АктуальныйЭлектронныйДокументОбъектаУчета(КонтекстФормирования.ВерсияДляОтправки,
...
Функция ДанныеПакетовДляФормирования(ИдентификаторыПакетов)
	...
	Запрос.Текст =
		...
		|ВЫБРАТЬ
		|	ДокументыПакетов.Документ,
		|	АктуальныеДокументыЭДО.ЭлектронныйДокумент КАК ДокументЭДО
