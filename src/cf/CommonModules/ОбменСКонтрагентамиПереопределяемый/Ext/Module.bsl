...
Процедура ПриОпределенииИспользуемыхТиповЭлектронныхДокументов(ИспользуемыеТипы) Экспорт
	...
	ТипыКДобавлению.Добавить(ТипыДокументов.АктСверкиВзаиморасчетов);
...
Процедура ЗаполнитьСоответствиеСтавокНДС(Соответствие) Экспорт
	...
	Соответствие.Вставить("22/122",  Перечисления.СтавкиНДС.НДС22);
	Соответствие.Вставить("7",       Перечисления.СтавкиНДС.НДС7);
	Соответствие.Вставить("7/107",   Перечисления.СтавкиНДС.НДС7);
	Соответствие.Вставить("5",       Перечисления.СтавкиНДС.НДС5);
	Соответствие.Вставить("5/105",   Перечисления.СтавкиНДС.НДС5);
	Соответствие.Вставить("без НДС", Перечисления.СтавкиНДС.БезНДС);
