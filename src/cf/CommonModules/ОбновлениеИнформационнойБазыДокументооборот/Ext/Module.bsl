...
Функция ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_32_7");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_1");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_2");
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_33_3",
		"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_33_3",
	...
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_33_4",
		"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_33_4",
		"aaaae101-a8dd-4515-aa92-2f3cc6aaaaaa",
		НСтр("ru = 'Создает табличную часть Пакеты в существующих документах ДанныеДокументаМЭДО'"));
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_5");
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_33_5",
		"ОбновлениеИнформационнойБазыДокументооборот.ЗаполнениеПолногоНаименованияИФормыДелХраненияДокументов",
		"158ae101-a8dd-4515-aa92-2f3cc6aaa723",
		НСтр("ru = 'Заполняет полное наименование с номером тома и части и форму документов в делах (томах)'"));
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_6");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_8");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_9");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_10");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_11");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_33_12");
	
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_33_13",
		"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_33_13",
		"5136a5bf-a395-43a6-869a-19e6983bb6af",
		НСтр("ru = 'Удаляет состояния ЭДО бумажных документов, которые еще не были сформированы'"));
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_34_1");
	
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_35_1",
		"ПерейтиНаВерсию_2_1_35_1",
		"317cbbd6-0b9d-4f9d-bba6-ce42ea5ec6d6",
		НСтр("ru = 'Проставляет АктуализироватьВерсию = Истина в РС НастройкиКонтрагентовМЭДО'"));
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_2");
	
	ДобавитьСтандартныйОтложенныйОбработчик(
		Обработчики, "2_1_35_4", "ПерейтиНаВерсию_2_1_35_4",
		"33FCBFD9-054E-4335-95F9-4545458830BF",
		НСтр("ru = 'РС ОтметкиВремениРегистровНезависимых: удалим записи для ДескрипторыДляОбъектов'"));
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_5");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_6");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_7");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_8");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_9");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_10");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_35_13");
	
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_36_1",
		"ЗаполнитьДатуСозданияСдаточныхОписей_2_1_36_1",
		"775cbbd9-0b9d-4f9d-bba6-ce42ea5ec6d6",
		НСтр("ru = 'Заполнение даты создания Передачи дел в архив'"));
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_36_3");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_37_2");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_37_3");
	
	// Отложенный обработчик перехода регистра ЭП
	РаботаСЭП.ДобавитьОбработчикОбновленияРегистраЭП_2_1_37(Обработчики);
...
Процедура ПервыйЗапуск() Экспорт
	...
	// Связи документов.
	СвязиДокументов.НастроитьСвязиКомплектаДокументов();
...
Функция ПараллельноеОтложенноеОбновлениеСВерсии() Экспорт
	...
	ПараллельноеОтложенноеОбновлениеСВерсии = "2.1.37.1";
...
Процедура ПерейтиНаВерсию_2_1_13_17() Экспорт
	...
	Константы.РасположениеШтампаЭПВPdf.Установить(Перечисления.МестаВставкиКартинки.ЛевыйВерхний);
...
Процедура ПерейтиНаВерсию_2_1_32_7() Экспорт
	
	// Базовая роль для МЭДО:
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.БазовыеПраваМЭДО, "c999acb1-d5f5-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_33_1() Экспорт
	
	Константы.РасширенияФайловICalendar.Установить("ICS ICAL IFB ICALENDAR");
		
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_33_2() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_33_3(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос = Новый Запрос(
			...
			|		Направление = ЗНАЧЕНИЕ(Перечисление.НаправленияСообщенийМЭДО.Входящее)) КАК СостоянияСрез
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеВходящихДокументов КАК ДанныеДокументов
			...
			|ИЗ
			|	РегистрСведений.СостоянияДокументовМЭДО.СрезПоследних( ,
			|		Направление = ЗНАЧЕНИЕ(Перечисление.НаправленияСообщенийМЭДО.Исходящее)) КАК СостоянияСрез
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеИсходящихДокументов КАК ДанныеДокументов
			|		ПО СостоянияСрез.Документ = ДанныеДокументов.Документ
			|ГДЕ
			|	ДанныеДокументов.СостояниеМЭДО = ЗНАЧЕНИЕ(Перечисление.СостоянияДокументовМЭДО.ПустаяСсылка)
			|;
			|
			|ВЫБРАТЬ
			|	СУММА(КолвоДокументов) КАК КолвоДокументов
			|ИЗ
			|	ВтПромежуточная
			|");
		Выборка = Запрос.Выполнить().Выбрать();
	...
	Пока Выборка.Следующий() Цикл
		Попытка
			Делопроизводство.ЗаписатьДанныеДокумента(Выборка.Документ, "СостояниеМЭДО", Выборка.СостояниеМЭДО);
			ОбработаноОбъектов = ОбработаноОбъектов + 1;
		Исключение
			ПроблемныхОбъектов = ПроблемныхОбъектов + 1;
	...
	Если ОбработаноОбъектов = 0 И ПроблемныхОбъектов > 0 Тогда
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Процедуре %1 не удалось записать состояния МЭДО для некоторых документов (пропущены): %2'"),
			"ПерейтиНаВерсию_2_1_33_3",
			ПроблемныхОбъектов);
	КонецЕсли;
...
// Параметры:
//  Параметры - Структура - Параметры обработчика
Процедура ПерейтиНаВерсию_2_1_33_4(Параметры) Экспорт
...
// Заполняет срок оперативного хранения в номенклатуре дел
// 
Процедура ПерейтиНаВерсию_2_1_33_5() Экспорт
	
	Запрос = Новый Запрос(
		"ВЫБРАТЬ ПЕРВЫЕ 500
		|	НоменклатураДел.Ссылка КАК Ссылка,
		|	НоменклатураДел.ФормаДокументов КАК ФормаДокументов,
		|	НоменклатураДел.СрокОперативногоХранения КАК СрокОперативногоХранения
		|ИЗ
		|	Справочник.НоменклатураДел КАК НоменклатураДел
		|ГДЕ
		...
		|	НоменклатураДел.СрокОперативногоХранения
		|ИЗ
		|	Справочник.НоменклатураДел КАК НоменклатураДел
		|ГДЕ
		|	НоменклатураДел.ФормаДокументов = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)");
	...
	Пока Не РезультатЗапроса.Пустой() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Не ЗначениеЗаполнено(Выборка.СрокОперативногоХранения) Тогда
				НоменклатураОбъект.СрокОперативногоХранения = 1;
			КонецЕсли;
			Если Не ЗначениеЗаполнено(Выборка.ФормаДокументов) Тогда
				НоменклатураОбъект.ФормаДокументов = Перечисления.ВариантыФормДокументов.Бумажная;
			КонецЕсли;
...
// Заполняет полное наименование и форму документов в делах (томах)
// 
// Параметры:
//  Параметры - Структура - Параметры обработчика	
Процедура ЗаполнениеПолногоНаименованияИФормыДелХраненияДокументов(Параметры) Экспорт
	
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		
		Запрос = Новый Запрос(
			"ВЫБРАТЬ
			|	КОЛИЧЕСТВО(ДелаХраненияДокументов.Ссылка) КАК КолвоЗаписей
			|ИЗ
			|	Справочник.ДелаХраненияДокументов КАК ДелаХраненияДокументов
			|ГДЕ
			...
			|
			|ВЫБРАТЬ
			|	КОЛИЧЕСТВО(ДелаХраненияДокументов.Ссылка)
			|ИЗ
			|	Справочник.ДелаХраненияДокументов КАК ДелаХраненияДокументов
			|ГДЕ
	...
	Запрос = Новый Запрос(
		...
		|	НоменклатураДелСпр.ФормаДокументов КАК НоменклатураДелФормаДокументов,
		...
		|	НоменклатураДелСпр.ПолноеНаименование,
		|	НоменклатураДелСпр.ФормаДокументов,
		|	НоменклатураДелСпр.Ссылка
		|ИЗ
		|	Справочник.ДелаХраненияДокументов КАК ДелаХраненияДокументов
		|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.НоменклатураДел КАК НоменклатураДелСпр
		|		ПО ДелаХраненияДокументов.НоменклатураДел = НоменклатураДелСпр.Ссылка
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			НоменклатураДелФормаДокументов = Выборка.НоменклатураДелФормаДокументов;
			Если Не ЗначениеЗаполнено(НоменклатураДелФормаДокументов) Тогда
				ЗаблокироватьДанныеДляРедактирования(Выборка.НоменклатураДел);
				НоменклатураДелОбъект = Выборка.НоменклатураДел.ПолучитьОбъект();
				НоменклатураДелОбъект.ФормаДокументов = Перечисления.ВариантыФормДокументов.Бумажная;
				ОбновлениеИнформационнойБазы.ЗаписатьДанные(НоменклатураДелОбъект);
				РазблокироватьДанныеДляРедактирования(Выборка.НоменклатураДел);
				НоменклатураДелФормаДокументов = Перечисления.ВариантыФормДокументов.Бумажная;
			КонецЕсли;
			...
			ДелоОбъект.ФормаДокументов = НоменклатураДелФормаДокументов;
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось заполнить полное наименование или форму документов дела ""%1"" по причине: %2'"),
	...
	Если ОбработаноОбъектов = 0 И ПроблемныхОбъектов > 0 Тогда
		ТекстСообщения =
			НСтр("ru = 'Процедуре ""ЗаполнениеПолногоНаименованияИФормыДелХраненияДокументов"" не удалось обработать
			| дела (тома).'");
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
// Заполняет признак проведен у документов ПередачаДелВАрхив и УничтожениеДел
// 
Процедура ПерейтиНаВерсию_2_1_33_6() Экспорт
	
	Запрос = Новый Запрос(
		"ВЫБРАТЬ ПЕРВЫЕ 1000
		|	ПередачаДелВАрхив.Ссылка КАК Ссылка,
		|	ПередачаДелВАрхив.Дата КАК ДатаДокумента
		|ИЗ
		|	Документ.ПередачаДелВАрхив КАК ПередачаДелВАрхив
		|ГДЕ
...
Процедура ПерейтиНаВерсию_2_1_33_8() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_33_9() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2024Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_33_13(Параметры) Экспорт
...
Процедура ПерейтиНаВерсию_2_1_33_10() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_33_11() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_33_12() Экспорт
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_34_1() Экспорт
...
// Параметры:
//  Параметры - Структура - Параметры обработчика
Процедура ПерейтиНаВерсию_2_1_35_1(Параметры) Экспорт 
	...
	Если ОбработаноОбъектов = 0 И ПроблемныхОбъектов > 0 Тогда
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Процедуре %1 не удалось создать записи в РС ""%2"" для некоторых объектов (пропущены): %3'"),
			"ПерейтиНаВерсию_2_1_35_1",
...
// Для доработки, касающейся регистрационных штампов.
Процедура ПерейтиНаВерсию_2_1_35_2() Экспорт
	
	// Заполняем новое поле в РС НастройкиОрганизацийМЭДО:
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	Организация
		|ИЗ
	...
	// В настройках пользователей меняет тип настройки для положения рег.штампов и штрихкодов с
...
// РС ОтметкиВремениРегистровНезависимых: удалим записи для ДескрипторыДляОбъектов
//
Процедура ПерейтиНаВерсию_2_1_35_4(Параметры) Экспорт 
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			// удалим запись в РС именно в коносли  - чтобы не грузить ее в следующий раз

			Набор = РегистрыСведений.ОтметкиВремениРегистровНезависимых.СоздатьНаборЗаписей();
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось записать ОтметкиВремениРегистровНезависимых
					|по причине:
					|%1'"),
				СтекОшибки); 
			ЗаписьЖурналаРегистрации(
	...
	Если ОбработаноОбъектов = 0 И ПроблемныхОбъектов > 0 Тогда
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Процедуре ""%1"" не удалось записать ОтметкиВремениРегистровНезависимых для всех  ""%2""
			|для некоторых объектов (пропущены): %3'"),
			"ПерейтиНаВерсию_2_1_35_4", "ОтметкиВремениРегистровНезависимых", ПроблемныхОбъектов);
	КонецЕсли;
...
// 
Процедура ПерейтиНаВерсию_2_1_35_5() Экспорт
...
// Вносит в РС ВерсииКлассификаторов запись о АУЦ
// 
Процедура ПерейтиНаВерсию_2_1_35_6() Экспорт
	
	НаборЗаписей = РегистрыСведений.ВерсииКлассификаторов.СоздатьНаборЗаписей();
	НаборЗаписей.Отбор.Идентификатор.Установить("AccreditedCA"); 
	НаборЗаписей.Прочитать();
	...
	Менеджер = РегистрыСведений.ВерсииКлассификаторов.СоздатьМенеджерЗаписи();
	Менеджер.Идентификатор = "AccreditedCA";
	Менеджер.Версия = 0;
	Менеджер.ДатаОбновления = Дата("00010101");
	Менеджер.Наименование = "Список аккредитованных удостоверяющих центров";
	Менеджер.ОбновлятьАвтоматически = Истина;
	Менеджер.ОбработкаРазделенныхДанных = Ложь;
	Менеджер.ОбщиеДанные = Истина; 
	Менеджер.СохранятьФайлВКэш = Ложь;
...
// 
Процедура ПерейтиНаВерсию_2_1_35_7() Экспорт
	
	Константы.ОтсрочкаУдаленияДанныхУничтоженныхДокументов.Установить(14);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_35_8() Экспорт
	
	НаборЗаписей = РегистрыСведений.УдалитьХранимыеФайлыВерсий.СоздатьНаборЗаписей();
	НаборЗаписей.Записать(); // без отбора, стираем все
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_35_9() Экспорт
	
	РаботаСЭП.ОбновитьРегистрЭлектронныхПодписей_2_1_35();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_35_10() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2025Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_35_13() Экспорт
	
	// Исправление настройки обратной связи
	СвязиДокументов.СоздатьНастройкуСвязи(Справочники.ТипыСвязей.Содержит,
		Справочники.ВидыВнутреннихДокументов.ПустаяСсылка(),
...
//
Процедура ЗаполнитьДатуСозданияСдаточныхОписей_2_1_36_1(Параметры) Экспорт
...
Процедура ПерейтиНаВерсию_2_1_36_3() Экспорт
	
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ЧтениеМЧДЭДО", 
		"c999acb1-d5f5-11de-a544-00179ab398dc");
	
	// В профиль Ответственные за ЭДО
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ДобавлениеИзменениеМЧДКонтрагентовЭДО", 
		"2be49dd2-337f-4b3a-af9d-17fe9f8325ec");
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ДобавлениеИзменениеМЧДОрганизацийЭДО", 
		"2be49dd2-337f-4b3a-af9d-17fe9f8325ec");
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ДобавлениеИзменениеНоменклатурыКонтрагентовБЭД", 
		"2be49dd2-337f-4b3a-af9d-17fe9f8325ec");
...
Процедура ПерейтиНаВерсию_2_1_37_2() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_37_3() Экспорт
