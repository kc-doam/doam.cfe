...
// Отбор элементов массива по типу. Возвращает отфильтрованный массив, 
// в котором остаются только элементы переданного типа для отбора
// 
// Параметры:
//  Массив - Массив из Произвольный - Массив, из которого нужно отобрать элементы переданного типа
//  ТипДляОтбора - Тип - Тип, по которому нужно отобрать элементы из переданного массива
// 
// Возвращаемое значение:
//  Массив из Произвольный - Отбор элементов массива по типу
