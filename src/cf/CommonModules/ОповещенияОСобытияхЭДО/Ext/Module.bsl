...
Процедура ПроверитьНовыеЭлектронныеДокументы() Экспорт
	...
	ИдентификаторыУчетныхЗаписей = Неопределено;
	ОбменСКонтрагентамиДОСобытия.ПередРегламентнойПроверкойНаличияНовыхДокументовВСервисеЭДО(
		ИдентификаторыУчетныхЗаписей);
