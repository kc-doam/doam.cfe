...
Процедура ВыбратьПользователей(ДоступныеТипы, ОтмеченныеЗначения, ПараметрыВыбора, Обработчик)
	ВыборГруппПользователей = ДоступныеТипы.СодержитТип(Тип("СправочникСсылка.РабочиеГруппы"));
	ВыбранныеПользователи = ОтмеченныеЗначения.ВыгрузитьЗначения();
	
	Если ДоступныеТипы.СодержитТип(Тип("СправочникСсылка.РабочиеГруппы")) Тогда 
