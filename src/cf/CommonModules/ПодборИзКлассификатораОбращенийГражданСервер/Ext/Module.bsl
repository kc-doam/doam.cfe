...
//
// Параметры:
//    ТипЭлемента - Строка - Имя справочника классификатора обращений.
//    КодЭлемента - Строка - Код элемента в нужном справочнике.
//
// Возвращаемое значение:
//	- СправочникСсылка.РазделыОбращений
//	- СправочникСсылка.ТематикиОбращений
//	- СправочникСсылка.ТемыОбращений
...
Функция ПолучитьЭлементКлассификатора(ТипЭлемента, КодЭлемента) Экспорт
	...
	Запрос = Новый Запрос(СтрШаблон("ВЫБРАТЬ Ссылка ИЗ %1 
		|ГДЕ Код = &КодЭлемента И Не ПометкаУдаления", ТипЭлемента));
