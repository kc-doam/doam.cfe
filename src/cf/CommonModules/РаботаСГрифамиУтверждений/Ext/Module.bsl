...
Процедура ОбработатьГрифыПриВыполненииЗадачи(БизнесПроцесс, Документ, Задача, РезультатУтверждения) Экспорт
	...
	Для Каждого ГрифУтверждения Из ДокументОбъект.ГрифыУтверждения Цикл
		Если ГрифУтверждения.АвторУтверждения = Задача.Исполнитель 
			Или ГрифУтверждения.АвторУтверждения = Задача.РольИсполнителя
			Или ГрифУтверждения.АвторУтверждения = БизнесПроцесс.Исполнитель Тогда
