...
Процедура ВыполнитьАвтоматическуюКатегоризацию() Экспорт
	...
	Пока РезультатЗапроса.Следующий() Цикл
		...
		Для Каждого ТипОбъекта Из ПравилоАК.ТипыОбъектов Цикл
			...
			СтрокаТипДанных = "";
			Если ТипОбъекта.ТипДанных = Перечисления.ТипыОбъектов.ВнутренниеДокументы Тогда
				СтрокаТипДанных = "ВнутренниеДокументы";
			ИначеЕсли ТипОбъекта.ТипДанных = Перечисления.ТипыОбъектов.ВходящиеДокументы Тогда
				СтрокаТипДанных = "ВходящиеДокументы";
			ИначеЕсли ТипОбъекта.ТипДанных = Перечисления.ТипыОбъектов.ИсходящиеДокументы Тогда
				СтрокаТипДанных = "ИсходящиеДокументы";
