	...
	Для Каждого ОписаниеОбъекта Из ОписаниеОбъектов Цикл
		...
		Иначе
			...
			КодТранзакции = ПолучитьКодТранзакции(ОписаниеОбъекта.ТипРегламента, ОписаниеОбъекта.ТипЭлементаРегламента, 
				КодРегламента, ОписаниеОбъекта.СпособОбмена, ОписаниеОбъекта.ЭтоОтветнаяПодпись);
		КонецЕсли;
...
//  Строка
//
Функция ПолучитьКодТранзакции(ТипРегламента, ТипЭлементаРегламента, КодРегламента, СпособОбмена, ОтветнаяПодпись)
