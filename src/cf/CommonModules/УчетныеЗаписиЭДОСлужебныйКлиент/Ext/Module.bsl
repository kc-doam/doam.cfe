		...
		Если РезультатВыполнения.Свойство("НаборДанных") Тогда
			...
			Для Каждого ПодписываемыеДанные Из РезультатВыполнения.НаборДанных Цикл
				...
				Если ЗначениеЗаполнено(Доверенность) Тогда
					...
					ИННДоверенногоЛица = "";
					Если ЗначениеЗаполнено(Контекст.ДанныеПакета.РеквизитыПакета.ИННДоверенногоЛица) Тогда
						ИННДоверенногоЛица = Контекст.ДанныеПакета.РеквизитыПакета.ИННДоверенногоЛица;
					КонецЕсли;
