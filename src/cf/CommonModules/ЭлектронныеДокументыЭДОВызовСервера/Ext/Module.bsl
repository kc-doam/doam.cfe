...
Функция КаждыйДокументБезПодтвержденияИлиОтветнаяПодписьОтправлена(ЭлектронныеДокументы, ЭтоПакетнаяОбработка) Экспорт
	ПереченьСостоянийОтправкиОтветнойПодписи = ЭлектронныеДокументыЭДОСлужебный.ПереченьСостоянийОтправкиОтветнойПодписи();
	Если ЭтоПакетнаяОбработка Тогда
		СостоянияОтправкиОтветнойПодписи = ЭлектронныеДокументыЭДОСлужебный.ПакетноеСостояниеОтправкиОтветнойПодписиВходящихДокументов(
			ЭлектронныеДокументы);
	Иначе
		СостоянияОтправкиОтветнойПодписи = ЭлектронныеДокументыЭДОСлужебный.СостояниеОтправкиОтветнойПодписиВходящихДокументов(
			ЭлектронныеДокументы);
	КонецЕсли;
