...
Процедура ПриЗагрузкеСообщения(Сообщение, ДанныеСообщения, КонтекстДиагностики) Экспорт
	...
	ОбменСКонтрагентамиДОСлужебный.ПриЗагрузкеСообщенияЭДО(Сообщение, ДанныеСообщения, КонтекстДиагностики);
...
Процедура ПослеЗагрузкиНовогоЭлектронногоДокумента(ЗагруженныйДокумент, КонтекстДиагностики) Экспорт
	...
	ОбменСКонтрагентамиДОСобытия.ПослеЗагрузкиНовогоЭлектронногоДокумента(ЗагруженныйДокумент);
КонецПроцедуры
