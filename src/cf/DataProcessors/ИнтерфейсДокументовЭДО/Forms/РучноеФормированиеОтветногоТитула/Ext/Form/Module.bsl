...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РеквизитВернутьДанныеОтветногоТитула = Новый РеквизитФормы("ВернутьДанныеОтветногоТитула", 
		Новый ОписаниеТипов("Булево"));
	ДобавляемыеРеквизиты.Добавить(РеквизитВернутьДанныеОтветногоТитула);
...
Процедура ПодписатьИОтправить(Команда)
	...
	// Используется ЭтотОбъект, т.к. иначе будет выдавать ошибку, что нет такого реквизита. 
	// Реквизит добавляется программно
	Если ЭтотОбъект.ВернутьДанныеОтветногоТитула Тогда
