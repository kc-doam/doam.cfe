...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСКонтрагентамиДОСобытия.ОтправкаДокументовПоЭДОПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
...
Процедура ОтобразитьДанныеВыделенныхДокументов()
	...
	ОбменСКонтрагентамиДОСобытия.ОтправкаДокументовПоЭДОПриОтображенииДанныхВыделенныхДокументов(ЭтотОбъект);
