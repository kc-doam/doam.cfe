...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаЭПОблачнаяПодпись.Доступность = НаборКонстант.ИспользоватьЭлектронныеПодписи;
	Элементы.ГруппаЭПОблачнаяПодпись4.Доступность = НаборКонстант.ИспользоватьСервисОблачнойПодписи;
...
Процедура ИспользоватьЭлектронноЦифровыеПодписиПриИзменении(Элемент)
	...
	Если Не НаборКонстант.ИспользоватьЭлектронныеПодписи Тогда
		НаборКонстант.ИспользоватьСервисОблачнойПодписи = Ложь;
		Элементы.ГруппаЭПОблачнаяПодпись4.Доступность = Ложь;
	КонецЕсли;
...
&НаКлиенте
Процедура НастроитьСерверыОблачнойПодписи(Команда)
	
	Записать();
	
	ПараметрыФормы = Новый Структура;
	
	ОткрытьФорму("Справочник.ЭкземплярыСервераDSS.ФормаСписка", ПараметрыФормы,
		ЭтаФорма);
	
КонецПроцедуры

&НаКлиенте
Процедура НастроитьУчетныеЗаписиОблачнойПодписи(Команда)
	
	Записать();
	
	ПараметрыФормы = Новый Структура;
	
	ОткрытьФорму("Справочник.УчетныеЗаписиDSS.ФормаСписка", ПараметрыФормы,
		ЭтаФорма);
