...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Обработки.ЗагрузкаКлассификатораОбращенийГраждан.ЗаполнитьТаблицыФормыДаннымиКлассификатора(ЭтотОбъект);
...
Процедура Далее(Команда)
	...
	ИначеЕсли Элементы.Страницы.ТекущаяСтраница = Элементы.СтраницаВопросы Тогда
		...
		ПометитьНаУдалениеСтарыеЭлементы();
		Состояние(НСтр("ru = 'Помечаются на удаление неактуальные разделы, тематики, темы, вопросы.'"));
		
		// Это был последний пункт, ставим константу, что теперь дата актуальна:
		УстановитьНовуюДатуРедакцииКлассификатора();
	КонецЕсли;
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТематикиИТемы
...
Функция ЗагрузитьДанныеКлассификатораНаСервере(ИмяТаблицыФормы)
	...
	Если ТипЗнч(ЭтотОбъект[ИмяТаблицыФормы]) = Тип("ДанныеФормыДерево") Тогда
		ДанныеДляЗагрузки = Обработки.ЗагрузкаКлассификатораОбращенийГраждан.ПодготовитьДанныеДереваТематикИТемКЗагрузке(
			ЭтотОбъект);
...
&НаСервере
Процедура ПометитьНаУдалениеСтарыеЭлементы()
	
	Обработки.ЗагрузкаКлассификатораОбращенийГраждан.ПометитьНаУдалениеСтарыеЭлементы();
	
КонецПроцедуры

&НаСервере
Процедура УстановитьНовуюДатуРедакцииКлассификатора()
	
	Константы.АктуализироватьКлассификаторОбращенийГраждан.Установить(Ложь);
	Константы.ДатаРедакцииКлассификатораОбращенийГраждан.Установить(
		РаботаСОбращениями.ДатаРедакцииКлассификатораОбращений());
