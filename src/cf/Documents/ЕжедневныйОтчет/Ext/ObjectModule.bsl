...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Для Каждого Строка Из Работы Цикл
		ВидВремени = ВидВремениПоВидуРабот(ВидыВремени, Строка.ВидРабот);
...
Функция ВидВремениПоВидуРабот(СоответствиеВидыВремени, ВидРабот)
	
	ЭлементСоответствия = СоответствиеВидыВремени[ВидРабот];
	Если ЭлементСоответствия <> Неопределено Тогда
		ВидВремени = ЭлементСоответствия.ВидВремени;
	Иначе
