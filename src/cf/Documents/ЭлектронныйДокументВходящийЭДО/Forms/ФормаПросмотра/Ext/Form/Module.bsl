...
Процедура НадписьДокументДОНажатие(Элемент)
	...
	Если ЗначениеЗаполнено(ЭтотОбъект.ДокументДО) Тогда
		ПоказатьЗначение(, ЭтотОбъект.ДокументДО);
	Иначе
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	// Документооборот
	Если Элементы.Найти("ГруппаОтражениеВДО") = Неопределено Тогда;
		НоваяГруппа = Элементы.Вставить("ГруппаОтражениеВДО", Тип("ГруппаФормы"),, Элементы.ГруппаДанныеДокументов);
		НоваяГруппа.Вид = ВидГруппыФормы.ОбычнаяГруппа;
		НадписьДокументДОЗаголовок = Элементы.Добавить("НадписьДокументДОЗаголовок", Тип("ДекорацияФормы"), НоваяГруппа);
		НадписьДокументДОЗаголовок.Вид = ВидДекорацииФормы.Надпись;
		НадписьДокументДОЗаголовок.Заголовок = НСтр("ru='Документ 1С:Документооборот:'"); 
		НадписьДокументДО = Элементы.Добавить("НадписьДокументДО", Тип("ДекорацияФормы"), НоваяГруппа);
		НадписьДокументДО.Заголовок = НСтр("ru='<ДокументДО>'");
		НадписьДокументДО.Гиперссылка = Истина;
		НадписьДокументДО.УстановитьДействие("Нажатие", "НадписьДокументДОНажатие"); 
		НадписьДокументДО.Вид = ВидДекорацииФормы.Надпись;
		ДобавляемыеРеквизиты = Новый Массив;
		РеквизитДокументДО = Новый РеквизитФормы("ДокументДО", Новый ОписаниеТипов("СправочникСсылка.ВнутренниеДокументы"));
		ДобавляемыеРеквизиты.Добавить(РеквизитДокументДО);
...
Процедура НастроитьВидимостьИНаименованиеДействийПоСостояниюЭДО()
	...
	ОбменСКонтрагентамиДОСобытия.ЭлектронныйДокументВходящийЭДОПриНастройкеВидимостиДействий(ЭтотОбъект);
...
Процедура НастроитьЭлементыОтраженияВДО()
	...
	ЭтотОбъект.ДокументДО = ДокументыДО[Объект.Ссылка];
	
	Если ЗначениеЗаполнено(ЭтотОбъект.ДокументДО) Тогда
		Элементы["НадписьДокументДО"].Заголовок = ЭтотОбъект.ДокументДО;
	Иначе
