...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ВходящийДокумент", НСтр("ru = 'Входящий документ'"));
	Список.Параметры.УстановитьЗначениеПараметра("ВходящееПисьмо", НСтр("ru = 'Входящее письмо'"));
	Список.Параметры.УстановитьЗначениеПараметра("ВнутреннийДокумент", НСтр("ru = 'Внутренний документ'"));
	Список.Параметры.УстановитьЗначениеПараметра("ИсходящийДокумент", НСтр("ru = 'Исходящий документ'"));
