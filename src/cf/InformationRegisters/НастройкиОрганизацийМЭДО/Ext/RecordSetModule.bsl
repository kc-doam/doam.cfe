...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если МЭДОПереопределяемый.ЭтоМиграция() Тогда
		Возврат; // При миграции тоже не нужно проверять, но организацию нужно заполнить (выше).
	КонецЕсли;
	...
	// 
	Для Каждого Запись Из ЭтотОбъект Цикл
		// Обычно всегда будет набор из 1 записи.
		...
		Если Не СтроковыеФункцииКлиентСервер.ЭтоУникальныйИдентификатор(Запись.ИдентификаторМЭДО) Тогда
