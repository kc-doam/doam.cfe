...
Функция НеподходящиеТипыДляАвтораспознавания() Экспорт
	...
	МассивТипов.Добавить("Справочник.ШаблоныВнутреннихДокументов");
	МассивТипов.Добавить("Справочник.ШаблоныВходящихДокументов");
	МассивТипов.Добавить("Справочник.ШаблоныИсходящихДокументов");
