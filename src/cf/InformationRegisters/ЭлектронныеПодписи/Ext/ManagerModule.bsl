...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ЭлектронныеПодписи.УдалитьУникальныйИдентификатор КАК УдалитьУникальныйИдентификатор
	|ИЗ
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НаборЗаписей.Отбор.УдалитьУникальныйИдентификатор.Установить(Выборка.УдалитьУникальныйИдентификатор);
		Блокировка = Новый БлокировкаДанных;
		ЭлементБлокировки = Блокировка.Добавить(ПолноеИмяРегистра);
		ЭлементБлокировки.УстановитьЗначение("УдалитьУникальныйИдентификатор", Выборка.УдалитьУникальныйИдентификатор);
		НачатьТранзакцию();
		Попытка
		...
		Исключение
			...
			СвойстваКлюча = Новый Структура("УдалитьУникальныйИдентификатор",
				Выборка.УдалитьУникальныйИдентификатор);
