...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) // 2018-03
	...
	СоздатьДополнительныеПоляСписка();	// Колонки в таблице отобранных конрагентов, свойства которых отмечены 'ВыводитьНаГлавной'
	...
	// Скрытие элементов на Главной странице // 2018-03
