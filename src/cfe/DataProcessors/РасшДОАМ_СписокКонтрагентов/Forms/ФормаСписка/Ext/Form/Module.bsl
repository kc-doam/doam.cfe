...
Процедура ДобавитьРеквизитHTML(КонтрагентСсылка, HTMLТекст, ИмяСвойства, Подпись="")
	...
	Если ТЗ.Количество() > 0 Тогда
		...
		Для Каждого текЗнач Из ТЗ Цикл
			...
			Если НЕ (СвойствоРасш.Имя = "РИЦ"
				И текЗнач.Значение.Родитель.Наименование = "ВСЕ ОГВ") Тогда // 2025-05
			...
			Иначе
				...
				Запрос.УстановитьПараметр("Наименование", текЗнач.Значение.Наименование);
	...
	Если ТЗ.Количество() > 0 Тогда
		...
		Для Каждого текЗнач Из ТЗ Цикл
			...
			Если ТЗ.Индекс(текЗнач) = ТЗ.Количество() - 1 Тогда // 2025-05
				...
				И СвойствоРасш.Имя = "РИЦ" Тогда // 2025-05
		...
		КонецЦикла;
	Иначе
		Если СвойствоРасш.Имя = "РИЦ" Тогда // 2025-05 Упразднено
			ЗначениеСтрока = "не РИЦ";
		Иначе
